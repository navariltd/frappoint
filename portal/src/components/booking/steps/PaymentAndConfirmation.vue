	...
	<div class="flex flex-col lg:flex-row gap-6 lg:gap-8 w-full p-6 md:p-8">
		...
		<aside class="w-full lg:w-1/3">
			...
			>
				...
				<!-- Confirm Button -->
				<button
					class="w-full bg-primary hover:bg-primary-dark text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-3 mt-4"
				>
				...
				<p
					class="text-center text-[11px] text-gray-400 dark:text-gray-500 mt-4 leading-relaxed px-4"
				>
					By clicking "Confirm and Pay", you agree to our Terms of Service and
					Cancellation Policy.
				</p>
			</div>
		</aside>
